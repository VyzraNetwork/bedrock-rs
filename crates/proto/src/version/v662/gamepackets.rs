use super::packets::{
    ...
    LevelSoundEventPacket, LevelSoundEventV1Packet, LevelSoundEventV2Packet, LoginPacket,
...
gamepackets! {
    ...
    LevelSoundEventV1: LevelSoundEventV1Packet,
    ...
    LevelSoundEventV2: LevelSoundEventV2Packet,
